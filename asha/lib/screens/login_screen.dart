            ...
            children: [
              Expanded(
                child: TextButton.icon(
                  ...
                  label:
                      Text(l.otpResend, style: T.button.copyWith(fontSize: 16)),
                ),
              ),
              Expanded(
                child: TextButton.icon(
...
class _OtpBoxesState extends State<_OtpBoxes> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        // Six boxes that shrink rather than overflow. They were a fixed 46pt
        // each - 276pt of hard minimum inside a card that offers about 232pt on
